...
async function main() {
  ...
  const outputDir = path.join(process.cwd(), 'data', 'moma', 'descriptions', 'gemini_2_5_flash');
...
Output:
  data/moma/descriptions/gemini_2_5_flash/descriptions.jsonl
  data/moma/descriptions/gemini_2_5_flash/progress.json

Example:
  npm run generate-descriptions -- --limit=100       # Resume by default
  npm run generate-descriptions -- --force --limit=10  # Start fresh
`);
}
